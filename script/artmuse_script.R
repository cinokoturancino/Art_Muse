...
nodes <- read_csv("C:/Users/ASUS/Desktop/ESU25_Distant_Reading-main/R Second Week/Network/Art_Muse/data/nodes_artmuse.csv")
edges <- read_csv("C:/Users/ASUS/Desktop/ESU25_Distant_Reading-main/R Second Week/Network/Art_Muse/data/edges_artmuse.csv")
...
visNetwork(nodes, edges, width = "120%") %>%
...
# Interactive plot with customized edge width and layout
visNetwork(nodes, 
           edges, main = "Artists and Museums",
           width = "100%") %>% 
  visIgraphLayout(layout = "layout_with_fr")
...
nodes <- read.csv("C:/Users/ASUS/Desktop/ESU25_Distant_Reading-main/R Second Week/Network/Art_Muse/data/nodes_artmuse.csv")
# Sample data preview
# head(nodes)
...
edges <- read.csv("C:/Users/ASUS/Desktop/ESU25_Distant_Reading-main/R Second Week/Network/Art_Muse/data/edges_artmuse.csv")

# Create a visNetwork plot with customized nodes
visNetwork(nodes, 
           edges,
           main = "Artists and Museums",
           height = "500px", 
           width = "100%")
...
edges_1 <- read.csv("C:/Users/ASUS/Desktop/ESU25_Distant_Reading-main/R Second Week/Network/Art_Muse/data/edges_artmuse.csv")
nodes_1 <- read.csv("C:/Users/ASUS/Desktop/ESU25_Distant_Reading-main/R Second Week/Network/Art_Muse/data/nodes_artmuse.csv")
...
# Load customized node and edge data from CSV files
nodes_3 <- read.csv("C:/Users/ASUS/Desktop/ESU25_Distant_Reading-main/R Second Week/Network/Art_Muse/data/nodes_artmuse.csv")
edges_3 <- read.csv("C:/Users/ASUS/Desktop/ESU25_Distant_Reading-main/R Second Week/Network/Art_Muse/data/edges_artmuse.csv")
